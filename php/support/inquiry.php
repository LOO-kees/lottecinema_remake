...
<body>
    ...
    <section id="faq">
        <!-- 검색창 -->
        <form name="search" method="post" action="search_list.php">
            <div class="search">
                <input type="search" id="search" name="search" placeholder="검색어를 입력해주세요">
                <input type="submit" value="검색" id="search_btn" onsubmit="return form_check()">
            </div>
    ...
    <section id="m_inquiry">
        <form action="" name="m_inquiry" method="post">
            <div class="i_choice">
                <h2>문의선택</h2>
                <ul>
